      ...
      ! Evaluate the imaginary part.
            ...
            class default
               call nek_stop_error("The intent [OUT] argument 'vec_out' must be of type 'nek_zvector'",
     & this_module, 'resolvent_matvec')
            end select
         class default
            call nek_stop_error("The intent [IN] argument 'vec_in' must be of type 'nek_zvector'",
     & this_module, 'resolvent_matvec')
         end select
         end procedure
